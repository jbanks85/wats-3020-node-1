...
// TODONE write typeof statements for all constants values following 
...
//TODONE implement the addition of types according the quoted portion of the log statement
// log string + string
...
s1 += s2
console.log('s1:', s1, 's2:', s2, 's3:', s3);
//TODONE console.log the values of s1, s2, s3 after each statement
console.log()
...
//TODONE add the ternary operation to see how JS converts non boolean types into truthy/falsy
